define([
    'services/cloudify/cloudifySeries'
], function(CloudifySeries) {
    'use strict';

    describe('when generating timeseries from cloudify response', function() {

        describe('given two series', function() {
            var series = new CloudifySeries({
                seriesList: [
                    {
    ...
    describe("when creating annotations from cloudify response", function() {
